"""
WorkSphere Enterprise Engine: Attendance Geo-Fencing & Shift Boundary Rules (Module 08)
...
class EnterpriseAttendanceGeoFencingShiftBoundaryRulesEngine08:
    """
    Enterprise logic handler for Attendance Geo-Fencing & Shift Boundary Rules (Partition 08).
    """
    MODULE_INDEX = 8
