"""
WorkSphere Enterprise Engine: Healthcare Actuarial Risk Tables & Deductibles (Module 04)
...
class EnterpriseHealthcareActuarialRiskTablesDeductiblesEngine04:
    """
    Enterprise logic handler for Healthcare Actuarial Risk Tables & Deductibles (Partition 04).
    """
    MODULE_INDEX = 4
