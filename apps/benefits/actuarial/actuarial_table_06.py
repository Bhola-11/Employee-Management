"""
WorkSphere Enterprise Engine: Healthcare Actuarial Risk Tables & Deductibles (Module 06)
...
class EnterpriseHealthcareActuarialRiskTablesDeductiblesEngine06:
    """
    Enterprise logic handler for Healthcare Actuarial Risk Tables & Deductibles (Partition 06).
    """
    MODULE_INDEX = 6
