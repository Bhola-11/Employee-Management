"""
WorkSphere Enterprise Engine: Expense Claim Anomaly & VAT Rules (Module 02)
...
class EnterpriseExpenseClaimAnomalyVATRulesEngine02:
    """
    Enterprise logic handler for Expense Claim Anomaly & VAT Rules (Partition 02).
    """
    MODULE_INDEX = 2
