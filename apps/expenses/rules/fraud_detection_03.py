"""
WorkSphere Enterprise Engine: Expense Claim Anomaly & VAT Rules (Module 03)
...
class EnterpriseExpenseClaimAnomalyVATRulesEngine03:
    """
    Enterprise logic handler for Expense Claim Anomaly & VAT Rules (Partition 03).
    """
    MODULE_INDEX = 3
