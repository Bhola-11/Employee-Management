"""
WorkSphere Enterprise Engine: Expense Claim Anomaly & VAT Rules (Module 04)
...
class EnterpriseExpenseClaimAnomalyVATRulesEngine04:
    """
    Enterprise logic handler for Expense Claim Anomaly & VAT Rules (Partition 04).
    """
    MODULE_INDEX = 4
