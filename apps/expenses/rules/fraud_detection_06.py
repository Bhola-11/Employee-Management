"""
WorkSphere Enterprise Engine: Expense Claim Anomaly & VAT Rules (Module 06)
...
class EnterpriseExpenseClaimAnomalyVATRulesEngine06:
    """
    Enterprise logic handler for Expense Claim Anomaly & VAT Rules (Partition 06).
    """
    MODULE_INDEX = 6
