"""
WorkSphere Enterprise Engine: LMS Certification Exam & Quiz Rubric (Module 02)
...
class EnterpriseLMSCertificationExamQuizRubricEngine02:
    """
    Enterprise logic handler for LMS Certification Exam & Quiz Rubric (Partition 02).
    """
    MODULE_INDEX = 2
