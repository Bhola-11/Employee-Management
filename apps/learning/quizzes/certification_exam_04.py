"""
WorkSphere Enterprise Engine: LMS Certification Exam & Quiz Rubric (Module 04)
...
class EnterpriseLMSCertificationExamQuizRubricEngine04:
    """
    Enterprise logic handler for LMS Certification Exam & Quiz Rubric (Partition 04).
    """
    MODULE_INDEX = 4
