"""
WorkSphere Enterprise Engine: Statutory Leave Proration & Rollover Matrix (Module 02)
...
class EnterpriseStatutoryLeaveProrationRolloverMatrixEngine02:
    """
    Enterprise logic handler for Statutory Leave Proration & Rollover Matrix (Partition 02).
    """
    MODULE_INDEX = 2
