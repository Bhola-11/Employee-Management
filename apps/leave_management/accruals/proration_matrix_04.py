"""
WorkSphere Enterprise Engine: Statutory Leave Proration & Rollover Matrix (Module 04)
...
class EnterpriseStatutoryLeaveProrationRolloverMatrixEngine04:
    """
    Enterprise logic handler for Statutory Leave Proration & Rollover Matrix (Partition 04).
    """
    MODULE_INDEX = 4
