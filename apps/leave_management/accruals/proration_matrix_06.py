"""
WorkSphere Enterprise Engine: Statutory Leave Proration & Rollover Matrix (Module 06)
...
class EnterpriseStatutoryLeaveProrationRolloverMatrixEngine06:
    """
    Enterprise logic handler for Statutory Leave Proration & Rollover Matrix (Partition 06).
    """
    MODULE_INDEX = 6
