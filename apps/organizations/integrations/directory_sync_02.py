"""
WorkSphere Enterprise Engine: Active Directory / LDAP Sync Connector (Module 02)
...
class EnterpriseActiveDirectoryLDAPSyncConnectorEngine02:
    """
    Enterprise logic handler for Active Directory / LDAP Sync Connector (Partition 02).
    """
    MODULE_INDEX = 2
