"""
WorkSphere Enterprise Engine: Active Directory / LDAP Sync Connector (Module 03)
...
class EnterpriseActiveDirectoryLDAPSyncConnectorEngine03:
    """
    Enterprise logic handler for Active Directory / LDAP Sync Connector (Partition 03).
    """
    MODULE_INDEX = 3
