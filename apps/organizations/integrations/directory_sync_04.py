"""
WorkSphere Enterprise Engine: Active Directory / LDAP Sync Connector (Module 04)
...
class EnterpriseActiveDirectoryLDAPSyncConnectorEngine04:
    """
    Enterprise logic handler for Active Directory / LDAP Sync Connector (Partition 04).
    """
    MODULE_INDEX = 4
