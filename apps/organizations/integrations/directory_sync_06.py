"""
WorkSphere Enterprise Engine: Active Directory / LDAP Sync Connector (Module 06)
...
class EnterpriseActiveDirectoryLDAPSyncConnectorEngine06:
    """
    Enterprise logic handler for Active Directory / LDAP Sync Connector (Partition 06).
    """
    MODULE_INDEX = 6
