"""
WorkSphere Enterprise Engine: Payroll Tax Bracket & Withholding Engine (Module 02)
...
class EnterprisePayrollTaxBracketWithholdingEngineEngine02:
    """
    Enterprise logic handler for Payroll Tax Bracket & Withholding Engine (Partition 02).
    """
    MODULE_INDEX = 2
