"""
WorkSphere Enterprise Engine: Payroll Tax Bracket & Withholding Engine (Module 03)
...
class EnterprisePayrollTaxBracketWithholdingEngineEngine03:
    """
    Enterprise logic handler for Payroll Tax Bracket & Withholding Engine (Partition 03).
    """
    MODULE_INDEX = 3
