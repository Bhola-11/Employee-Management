"""
WorkSphere Enterprise Engine: Payroll Tax Bracket & Withholding Engine (Module 04)
...
class EnterprisePayrollTaxBracketWithholdingEngineEngine04:
    """
    Enterprise logic handler for Payroll Tax Bracket & Withholding Engine (Partition 04).
    """
    MODULE_INDEX = 4
