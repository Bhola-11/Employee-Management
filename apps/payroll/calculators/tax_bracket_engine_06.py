"""
WorkSphere Enterprise Engine: Payroll Tax Bracket & Withholding Engine (Module 06)
...
class EnterprisePayrollTaxBracketWithholdingEngineEngine06:
    """
    Enterprise logic handler for Payroll Tax Bracket & Withholding Engine (Partition 06).
    """
    MODULE_INDEX = 6
