"""
WorkSphere Enterprise Engine: Payroll Tax Bracket & Withholding Engine (Module 07)
...
class EnterprisePayrollTaxBracketWithholdingEngineEngine07:
    """
    Enterprise logic handler for Payroll Tax Bracket & Withholding Engine (Partition 07).
    """
    MODULE_INDEX = 7
