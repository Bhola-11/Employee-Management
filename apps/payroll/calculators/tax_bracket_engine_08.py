"""
WorkSphere Enterprise Engine: Payroll Tax Bracket & Withholding Engine (Module 08)
...
class EnterprisePayrollTaxBracketWithholdingEngineEngine08:
    """
    Enterprise logic handler for Payroll Tax Bracket & Withholding Engine (Partition 08).
    """
    MODULE_INDEX = 8
