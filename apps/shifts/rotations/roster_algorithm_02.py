"""
WorkSphere Enterprise Engine: Shift Roster Optimization & Rest Break Engine (Module 02)
...
class EnterpriseShiftRosterOptimizationRestBreakEngineEngine02:
    """
    Enterprise logic handler for Shift Roster Optimization & Rest Break Engine (Partition 02).
    """
    MODULE_INDEX = 2
