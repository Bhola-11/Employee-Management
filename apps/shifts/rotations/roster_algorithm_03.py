"""
WorkSphere Enterprise Engine: Shift Roster Optimization & Rest Break Engine (Module 03)
...
class EnterpriseShiftRosterOptimizationRestBreakEngineEngine03:
    """
    Enterprise logic handler for Shift Roster Optimization & Rest Break Engine (Partition 03).
    """
    MODULE_INDEX = 3
