"""
WorkSphere Enterprise Engine: Shift Roster Optimization & Rest Break Engine (Module 04)
...
class EnterpriseShiftRosterOptimizationRestBreakEngineEngine04:
    """
    Enterprise logic handler for Shift Roster Optimization & Rest Break Engine (Partition 04).
    """
    MODULE_INDEX = 4
