"""
WorkSphere Enterprise Engine: Global Travel Per-Diem & Hotel Tier Schedule (Module 02)
...
class EnterpriseGlobalTravelPerDiemHotelTierScheduleEngine02:
    """
    Enterprise logic handler for Global Travel Per-Diem & Hotel Tier Schedule (Partition 02).
    """
    MODULE_INDEX = 2
