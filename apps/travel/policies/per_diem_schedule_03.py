"""
WorkSphere Enterprise Engine: Global Travel Per-Diem & Hotel Tier Schedule (Module 03)
...
class EnterpriseGlobalTravelPerDiemHotelTierScheduleEngine03:
    """
    Enterprise logic handler for Global Travel Per-Diem & Hotel Tier Schedule (Partition 03).
    """
    MODULE_INDEX = 3
