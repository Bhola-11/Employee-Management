"""
WorkSphere Enterprise Engine: Global Travel Per-Diem & Hotel Tier Schedule (Module 04)
...
class EnterpriseGlobalTravelPerDiemHotelTierScheduleEngine04:
    """
    Enterprise logic handler for Global Travel Per-Diem & Hotel Tier Schedule (Partition 04).
    """
    MODULE_INDEX = 4
