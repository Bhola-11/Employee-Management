"""
WorkSphere Enterprise Engine: Global Travel Per-Diem & Hotel Tier Schedule (Module 06)
...
class EnterpriseGlobalTravelPerDiemHotelTierScheduleEngine06:
    """
    Enterprise logic handler for Global Travel Per-Diem & Hotel Tier Schedule (Partition 06).
    """
    MODULE_INDEX = 6
